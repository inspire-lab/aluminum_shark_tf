...
#include "tensorflow/compiler/plugin/aluminum_shark/hlo_evaluator_typed_visitor.h"
...
// the non-typed AluminumSharkHloEvaluator (parent evaluator) would not support
// them either in the type-agnostic handler. For e.g., HandleGetTupleElement in
// the parent type-agnostic evaluator will be able to accept Tuple primitive
// type, whereas AluminumSharkHloEvaluatorTypedVisitor cannot.
AluminumSharkHloEvaluator::AluminumSharkHloEvaluator(
    int64_t max_loop_iterations)
    : max_loop_iterations_(max_loop_iterations) {
  typed_visitors_[PRED] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<bool>>(this);
  typed_visitors_[U8] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<uint8>>(this);
  typed_visitors_[U16] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<uint16>>(this);
  typed_visitors_[U32] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<uint32>>(this);
  typed_visitors_[U64] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<uint64_t>>(this);
  typed_visitors_[S8] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<int8>>(this);
  typed_visitors_[S16] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<int16>>(this);
  typed_visitors_[S32] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<int32>>(this);
  typed_visitors_[S64] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<int64_t>>(this);
  typed_visitors_[F16] = absl::make_unique<
      AluminumSharkHloEvaluatorTypedVisitor<Eigen::half, float>>(this);
  typed_visitors_[F32] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<float>>(this);
  typed_visitors_[F64] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<double>>(this);
  typed_visitors_[C64] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<complex64>>(this);
  typed_visitors_[C128] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<complex128>>(
          this);
  ...
  typed_visitors_[BF16] =
      absl::make_unique<AluminumSharkHloEvaluatorTypedVisitor<bfloat16, float>>(
          this);

  typed_visitors_[TUPLE] =
      absl::make_unique<FunctionVisitor>([](HloInstruction*) {
        return Unimplemented(
            "AluminumSharkHloEvaluatorTypedVisitor: unhandled primitive type: "
            "TUPLE.");
      });
...
bool AluminumSharkHloEvaluator::TryEvaluate(HloInstruction* instruction,
                                            Literal* result) {
...
StatusOr<Literal> AluminumSharkHloEvaluator::EvaluateWithSubstitutions(
...
StatusOr<Literal> AluminumSharkHloEvaluator::EvaluateElementwiseBinaryOp(
...
StatusOr<Literal> AluminumSharkHloEvaluator::EvaluateElementwiseTernaryOp(
    HloOpcode opcode, const Literal& lhs, const Literal& rhs,
    const Literal& ehs) {
  std::unique_ptr<HloInstruction> lhs_instr =
      HloInstruction::CreateConstant(lhs.Clone());
...
StatusOr<Literal> AluminumSharkHloEvaluator::EvaluateElementwiseCompareOp(
...
StatusOr<Literal> AluminumSharkHloEvaluator::EvaluateElementwiseUnaryOp(
...
StatusOr<Literal> AluminumSharkHloEvaluator::EvaluateDotOp(
...
Status AluminumSharkHloEvaluator::HandleBitcast(HloInstruction* bitcast) {
...
Status AluminumSharkHloEvaluator::HandleGetDimensionSize(
...
Status AluminumSharkHloEvaluator::HandleSetDimensionSize(
...
Status AluminumSharkHloEvaluator::HandleParameter(HloInstruction* parameter) {
...
Status AluminumSharkHloEvaluator::HandleConstant(HloInstruction*) {
  return Status::OK();
}
...
Status AluminumSharkHloEvaluator::HandleConcatenate(
...
Status AluminumSharkHloEvaluator::HandleIsFinite(HloInstruction* is_finite) {
...
Status AluminumSharkHloEvaluator::HandleReal(HloInstruction* real) {
...
Status AluminumSharkHloEvaluator::HandleImag(HloInstruction* imag) {
...
Status AluminumSharkHloEvaluator::HandleComplex(HloInstruction* complex) {
...
Status AluminumSharkHloEvaluator::HandleCompare(HloInstruction* compare) {
...
Status AluminumSharkHloEvaluator::HandleTuple(HloInstruction* tuple) {
...
Status AluminumSharkHloEvaluator::HandleFft(HloInstruction* fft) {
...
Status AluminumSharkHloEvaluator::HandleGather(HloInstruction* gather) {
...
Status AluminumSharkHloEvaluator::HandleBroadcast(HloInstruction* broadcast) {
...
Status AluminumSharkHloEvaluator::HandleAfterAll(HloInstruction* after_all) {
  evaluated_[after_all] = LiteralUtil::CreateToken();
  return Status::OK();
}

Status AluminumSharkHloEvaluator::HandleAddDependency(
...
Status AluminumSharkHloEvaluator::HandleGetTupleElement(
...
Status AluminumSharkHloEvaluator::HandleCopyStart(HloInstruction* copy_start) {
...
Status AluminumSharkHloEvaluator::HandleCopyDone(HloInstruction* copy_done) {
...
Status AluminumSharkHloEvaluator::HandleCall(HloInstruction* call) {
...
Status AluminumSharkHloEvaluator::HandleFusion(HloInstruction* fusion) {
...
Status AluminumSharkHloEvaluator::HandleConditional(
...
Status AluminumSharkHloEvaluator::HandleSelect(HloInstruction* select) {
...
Status AluminumSharkHloEvaluator::HandleTupleSelect(
    HloInstruction* tuple_select) {
...
Status AluminumSharkHloEvaluator::HandleWhile(HloInstruction* while_hlo) {
  ...
  AluminumSharkHloEvaluator cond_evaluator(max_loop_iterations_);
  cond_evaluator.set_dynamic_dimension_inference(dynamic_dimension_inference_);
  AluminumSharkHloEvaluator loop_body_evaluator(max_loop_iterations_);
...
Status AluminumSharkHloEvaluator::HandleSort(HloInstruction* sort) {
  ...
  AluminumSharkHloEvaluator embedded_evaluator(max_loop_iterations_);
...
static StatusOr<bool> GenerateReduceOutputElement(
    ...
    HloComputation* function, AluminumSharkHloEvaluator* embedded_evaluator,
...
Status AluminumSharkHloEvaluator::HandleReduce(HloInstruction* instr) {
...
Status AluminumSharkHloEvaluator::HandleReduceWindow(HloInstruction* hlo) {
...
Status AluminumSharkHloEvaluator::HandleCustomCall(
...
std::unique_ptr<Array2D<Eigen::half>> AluminumSharkHloEvaluator::MatmulArray2D(
...
std::unique_ptr<Array2D<float>> AluminumSharkHloEvaluator::MatmulArray2D(
    const Array2D<float>& lhs, const Array2D<float>& rhs) {
  return MatmulArray2DImpl<float>(
      lhs, rhs, __xla_cpu_runtime_EigenSingleThreadedMatMulF32);
}

std::unique_ptr<Array2D<double>> AluminumSharkHloEvaluator::MatmulArray2D(
    const Array2D<double>& lhs, const Array2D<double>& rhs) {
  return MatmulArray2DImpl<double>(
      lhs, rhs, __xla_cpu_runtime_EigenSingleThreadedMatMulF64);
}

std::unique_ptr<Array2D<std::complex<float>>>
AluminumSharkHloEvaluator::MatmulArray2D(
...
std::unique_ptr<Array2D<std::complex<double>>>
AluminumSharkHloEvaluator::MatmulArray2D(
...
std::unique_ptr<Array2D<int32>> AluminumSharkHloEvaluator::MatmulArray2D(
